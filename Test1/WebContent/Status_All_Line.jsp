    ...
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
				   ...
				   String strSQL1 = "SELECT DISTINCT Status FROM List_All";   //고장 원인 코드를 중복값 제거하여 가져오는 쿼리문
				   ...
				   for(int i=0; i<Status_code.size(); i++){
					   String strSQL2 = "SELECT COUNT(Status) FROM List_All WHERE Status = \"" + Status_code.get(i) + "\"";   //각 고장 원인의 빈도수를 가져오는 쿼리문
