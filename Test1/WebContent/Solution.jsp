    ...
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
				   ...
				   String strSQL1 = "SELECT DISTINCT Line, Process, Solution FROM List_All";   //고장 원인 코드를 중복값 제거하여 가져오는 쿼리문
				   ...
				   for(int i=0; i<Solution_code.size(); i++){
					   String strSQL2 = "SELECT COUNT(Solution) FROM List_All WHERE Solution = \"" + Solution_code.get(i) + "\" and Line = \"" + a + "\" and Process = \"" + b + "\" and Stop >= \"" + T1 +  "\" and Stop <= \"" + T2 + "\"";   //각 고장 원인의 빈도수를 가져오는 쿼리문
